$tasks.Add('phpstan',@{
    ...
    script = {
        ...
        # Invoke-Expression 'docker run -it -v $("$(Get-Location):/app".Trim()) -w /app buzzingpixel-php bash -c "php -d memory_limit=4G /app/vendor/phpstan/phpstan/phpstan analyse config public/index.php src tests cli"'
