...
{
    /** @var FetchAllSoftware */
    private $service;

    /** @var SoftwareRecord[] */
    private $softwareRecordQueryAllReturn = [];
    ...
    public function testWhenNoVersions() : void
    {
        ...
        $model1 = $models[0];
        self::assertSame('id1', $model1->getId());
        self::assertSame('foo-name', $model1->getSlug());
        self::assertSame('Foo Name', $model1->getName());
        self::assertTrue($model1->isForSale());
        self::assertSame([], $model1->getVersions());

        $model2 = $models[1];
        self::assertSame('id2', $model2->getId());
        self::assertSame('bar-name', $model2->getSlug());
        self::assertSame('Bar Name', $model2->getName());
        self::assertFalse($model2->isForSale());
        self::assertSame([], $model2->getVersions());
    }
    ...
    public function testWithVersions() : void
    {
        ...
        $model1Versions = $model1->getVersions();
        self::assertCount(1, $model1Versions);

        $model1Version1 = $model1Versions[0];
        self::assertSame('svid1', $model1Version1->getId());
        self::assertSame($model1, $model1Version1->getSoftware());
        self::assertSame('1', $model1Version1->getMajorVersion());
        self::assertSame('1.0.2', $model1Version1->getVersion());
        self::assertSame('/foo/download/file', $model1Version1->getDownloadFile());
        self::assertSame(
            '2019-12-08T20:05:23+00:00',
            $model1Version1->getReleasedOn()->format(
        ...
        $model2Versions = $model2->getVersions();
        self::assertCount(2, $model2Versions);

        $model2Version1 = $model2Versions[0];
        self::assertSame('svid2', $model2Version1->getId());
        self::assertSame($model2, $model2Version1->getSoftware());
        self::assertSame('3', $model2Version1->getMajorVersion());
        self::assertSame('3.4.6', $model2Version1->getVersion());
        self::assertSame('', $model2Version1->getDownloadFile());
        self::assertSame(
            '2013-01-04T20:05:23+00:00',
            $model2Version1->getReleasedOn()->format(
                DateTimeInterface::ATOM
            )
        );

        $model2Version2 = $model2Versions[1];
        self::assertSame('svid3', $model2Version2->getId());
        self::assertSame($model2, $model2Version2->getSoftware());
        self::assertSame('10', $model2Version2->getMajorVersion());
        self::assertSame('10.1.8', $model2Version2->getVersion());
        self::assertSame('', $model2Version2->getDownloadFile());
        self::assertSame(
            '1999-01-04T20:05:23+00:00',
            $model2Version2->getReleasedOn()->format(
                DateTimeInterface::ATOM
            )
        );
    }
