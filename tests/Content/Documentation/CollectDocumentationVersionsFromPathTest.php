...
class CollectDocumentationVersionsFromPathTest extends TestCase
{
    ...
    private function validatePrimaryVersion(
        ...
        assert($page1Section1Content1HeadingPayload instanceof HeadingPayload);
        ...
        assert($page1Section1Content4ListPayload instanceof ListPayload);
        self::assertSame(
            [
                'Edge 41 or greater',
        ...
        assert($page4Section1Content2CodeBlock instanceof CodeblockPayload);
