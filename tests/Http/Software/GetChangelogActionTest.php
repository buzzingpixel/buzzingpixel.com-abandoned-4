...
class GetChangelogActionTest extends TestCase
{
    ...
    private GetChangelogAction $action;

    private int $pageNum                             = 1;
    private string $softwareInfoChangelogExternalUrl = '';
    private int $releasePayloadCount                 = 0;
    private bool $noResponderExpectation             = false;
    ...
    /** @var mixed[] */
    private array $responderInvokeArgs;
